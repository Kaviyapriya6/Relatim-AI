...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12">
      <motion.div
        ...
        <Card className="p-8">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col items-center space-y-4">
              ...
              >
                <div className="w-full h-20 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg flex items-center justify-center text-sm text-gray-500 hover:border-green-500 transition-colors cursor-pointer">
                  <div className="text-center">
