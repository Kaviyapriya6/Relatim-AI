...
const Header = ({ onMenuToggle, isMobileMenuOpen }) => {
  ...
  // Derive a stable display name similar to how chat contact names are resolved
  const displayName = useMemo(() => {
    if (!user) return 'User';
    // Prefer explicit first + last when both exist & non-empty
    if (user.first_name && user.last_name) return `${user.first_name} ${user.last_name}`.trim();
    // If there is a single composite name field
    if (user.name) return user.name;
    // If only one of first/last present use whichever exists
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="hidden md:flex flex-1 max-w-lg mx-8 relative">
          <div className="relative w-full">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
            />
                        ...
                        {combinedSearchResults.filter(r => r.type === 'message').map((result) => (
                          ...
                          >
                            <div className="flex items-start space-x-3">
                              <Avatar
                                src={result.sender?.profile_photo}
        ...
        <div className="flex items-center space-x-4">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500"
          >
          ...
          <button
            ...
            className="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500"
          >
            {theme === 'dark' ? (
              <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20">
          ...
          {/* Notifications */}
          <button className="p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-green-500 relative">
              ...
              <div className="flex items-center space-x-3 cursor-pointer">
                <div className="relative">
                  <Avatar
                    ...
                    fallback={user?.first_name && user?.last_name ? `${user.first_name} ${user.last_name}` : user?.email || 'User'}
                    size="medium"
            ...
            <div className="px-4 py-3 border-b border-gray-200 dark:border-gray-600">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <StatusIndicator status={user?.is_online ? "online" : "offline"} showText size="small" />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  onChange={handleSearchChange}
                  autoFocus
                  className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 rounded-lg bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
              </div>
            </div>
